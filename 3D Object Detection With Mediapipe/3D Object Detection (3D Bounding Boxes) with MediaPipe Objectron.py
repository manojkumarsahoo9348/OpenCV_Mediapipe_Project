...
mug_url = 'https://goodstock.photos/wp-content/uploads/2018/01/Laptop-Coffee-Mug-on-Table.jpg'
mug_image = url_to_array(mug_url)
...
# Inference
results = objectron.process(image=mug_image)
...
annotated_image = mug_image.copy()
